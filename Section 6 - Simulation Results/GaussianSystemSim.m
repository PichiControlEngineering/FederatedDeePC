...
save("Data\GaussianSimulationData3", "Results", "N_sims", "N_order", "N_sys","T","l","GapMatCell","lambda_g", "sys_cell_cell" , "plot_cell_cell", "matNames", "r")
...
%% PARAMETERS
    ...
    gap_list = gap_mats(:,1);
    alpha_list = zeros(N_sys, 2 + 2*numel(eps_list)); 
    ...
    for k = 1:numel(eps_list)
        ...
        % Save weights
        alpha_list(prune_select, 2*k+1) = alpha_prune;
